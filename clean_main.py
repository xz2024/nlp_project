...
'''
    set the input and output folder, then run the clean_main.py to generatethe clean wav files.
'''
...
if __name__ == '__main__':
    ...
    parser.add_argument('--g_pretrained_ckpt', type=str, default= './weights.ckpt')
    parser.add_argument('--cfg_file', type=str, default='./train.opts')

    parser.add_argument('--test_files', type=list, nargs='+', default= list(['./dataset/noise/']))
    parser.add_argument('--seed', type=int, default=111, help="Random seed (Def: 111).")
    parser.add_argument('--synthesis_path', type=str, default='./dataset/clean/', help='Path to save output samples (Def: segan_samples).')
